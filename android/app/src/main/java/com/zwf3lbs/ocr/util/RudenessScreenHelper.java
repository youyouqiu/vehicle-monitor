...
public class RudenessScreenHelper {
     ...
     */
    public static void   resetDensity(Context context, float designWidth, float designHeight){
        if(context == null)
            return;
        ...
        resources.getDisplayMetrics().xdpi = size.y/designHeight*72f;
        //resources.getDisplayMetrics().ydpi = size.y/designHeight*72f;
        DisplayMetrics metrics = getMetricsOnMiui(context.getResources());
        if(metrics != null)
            metrics.xdpi =  size.y/designHeight*72f;
    }
     ...
     * @param width 设计稿宽度
     */
    public RudenessScreenHelper(Application application, float width, float height){
        ...
        activityLifecycleCallbacks = new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                ...
                resetDensity(mApplication, designWidth, designHeight);
                resetDensity(activity, designWidth, designHeight);
            }
