          ...
          <View style={styles.block}>
            ...
            <View style={styles.totalContainer}>
              <View style={styles.totalWraper}>
                <Image
                  source={dataType === 3 ? IconMeli1 : oilFuel1}
                  resizeMode="contain"
                  style={styles.alarmIcon}
                />
                <Text style={[styles.totalText, Platform.OS !== 'ios' ? { fontFamily: '' } : null]}>
                  {dataTypeText}
                  <Text style={[styles.totalNumber, Platform.OS !== 'ios' ? { fontFamily: '' } : null]}>{this.renderTotalNumber(agg)}</Text>{unit}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.totalContainer}>
              <View style={[styles.maxMinContainer, styles.maxContainer]}>
                <Text style={[styles.maxMinText, styles.txtRight]}>
                  {`${getLocale('highest')} `}
                  <Text style={styles.maxMinNumber}>{this.renderNumber(agg.max)}</Text>{unit}
                </Text>
                <Text style={[styles.maxMinText, styles.txtRight]}>
              ...
              <View style={styles.maxMinContainer}>
                <Text style={styles.maxMinText}>
                  {`${getLocale('lowest')} `}
                  <Text style={styles.maxMinNumber}>{this.renderNumber(agg.min)}</Text>{unit}
                </Text>
                <Text style={styles.maxMinText}>
