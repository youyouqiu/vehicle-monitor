...
import ipIcon from '../../../static/image/domain.png'; // 密码图标
...
export default class InputComponent extends Component {
  ...
  render() {
    ...
    const domainTop = Platform.OS === 'android' ? 11 : 7;
    const domainStyle = inputType === 'ip' ? { height: 18, top: domainTop } : null;
    return (
      <View
        style={[styles.container, style]}
      >
        <Image
          style={[styles.iconLeft, domainStyle]}
          source={iconLeft}
        />
        <TextInput
          maxLength={25}
