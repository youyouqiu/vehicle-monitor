...
// action
const INIT_ACTION = { type: 'mileStatistics/SAGA/INIT_ACTION' };
const INIT_START_ACTION = { type: 'mileStatistics/INIT_START_ACTION' };
const INIT_SUCCESS_ACTION = { type: 'mileStatistics/INIT_SUCCESS_ACTION' };
const INIT_FAIL_ACTION = { type: 'mileStatistics/INIT_FAIL_ACTION' };

const GET_DETAILS_START_ACTION = { type: 'mileStatistics/GET_DETAILS_START_ACTION' };
const GET_DETAILS_ACTION = { type: 'mileStatistics/SAGA/GET_DETAILS_ACTION' };
const GET_DETAILS_SUCCESS_ACTION = { type: 'mileStatistics/GET_DETAILS_SUCCESS_ACTION' };
const GET_DETAILS_FAIL_ACTION = { type: 'mileStatistics/GET_DETAILS_FAIL_ACTION' };

const RESET_DETAIL_ACTION = { type: 'mileStatistics/SAGA/RESET_DETAIL_ACTION' };
const RESET_DETAIL_START_ACTION = { type: 'mileStatistics/RESET_DETAIL_START_ACTION' };
const RESET_DETAIL_SUCCESS_ACTION = { type: 'mileStatistics/RESET_DETAIL_SUCCESS_ACTION' };

const RESET_DATA = { type: 'mileStatistics/RESET_DATA' };
...
const mileStatisticsReducers = (state = defaultState, { type, payload }) => {
  let newState = null;
  switch (type) {
...
function* initRequest ({ payload }) {
  ...
  const barResult = yield call(getMileBar, param);
...
function* getDetailData ({ payload }) {
  try {
    ...
    const result = yield call(getMileDetailData, {
      moniterId,
      startTime: `${startTime} 00:00:00`,
      endTime: nowEndTime,
    });
